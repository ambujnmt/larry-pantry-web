...
import { getProducts, createProduct, updateProduct, deleteProduct, deleteProductImage, getCategories, getUnits, getBrands, dtOptions, getProductReviews } from "../../utils/adminApi"
                ...
                {products.length === 0 ? (
                  ...
                  <tr key={p.id}>
                    ...
                    <td className="align-middle">
                      ...
                      <small className="text-muted"><ProductRatingCell productId={p.id} /></small>
                    </td>
                    ...
                    <td className="align-middle">
                      <button className="btn btn-sm btn-outline-info m-1" onClick={() => { setViewItem(p); setActiveImage(null) }}><i className="fa fa-eye" /></button>
                      <button className="btn btn-sm btn-outline-primary m-1" onClick={() => openEdit(p)}><i className="fa fa-edit" /></button>
                      <button className="btn btn-sm btn-outline-danger m-1" onClick={() => handleDelete(p.id)} disabled={deleting === p.id}>
              ...
              <div className="modal-content">
                ...
                <div className="modal-body">
                    ...
                    <div className="col-md-8">
                      <div className="d-flex justify-content-between align-items-start mb-3">
                        <div>
                          ...
                          <div className="mb-1"><ProductRatingCell productId={viewItem.id} /></div>
                  ...
                  <div className="float-end">
                    <small>Created Date: <b className="me-4">{viewItem.created_at ? new Date(viewItem.created_at).toLocaleDateString("en-US", { day: "2-digit", month: "short", year: "numeric" }) : '—'}</b>
