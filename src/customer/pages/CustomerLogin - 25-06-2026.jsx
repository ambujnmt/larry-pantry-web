              ...
              {tab === "register" && (
                <>
                  ...
                  <form onSubmit={handleRegister} noValidate>
                    <div className="mb-3">
                      <label className="form-label small text-secondary" htmlFor="f-name">First Name</label>
                      <div className="position-relative">
                        <span className="cl-icon"><i className="fa fa-user" /></span>
                        <input id="f-name" type="text" className="form-control cl-input"
                    ...
                    <div className="mb-3">
                      <label className="form-label small text-secondary" htmlFor="l-name">Last Name</label>
                      <div className="position-relative">
                        <span className="cl-icon"><i className="fa fa-user" /></span>
                        <input id="l-name" type="text" className="form-control cl-input"
                    ...
                    <div className="mb-3">
                      ...
                      <div className="position-relative">
                        ...
                        <input id="cl-phone" type="tel" className="form-control cl-input"
                          placeholder="Enetr your phone no." value={mobile}
