                    ...
                    <>
                      ...
                      {!isFamilyPersonal && (
                        <div className="mb-3">
                          ...
                          <div className="position-relative">
                            <span className="cl-icon"><i className="fa fa-building" /></span>
                            <input type="text" className="form-control cl-input" placeholder="Enter your business name"
                      ...
                      <div className="row">
                        ...
                        <div className="col-md-6 mb-4">
                          ...
                          <div className="position-relative">
                            <span className="cl-icon"><i className="fa fa-phone" /></span>
                            <input type="text" className="form-control cl-input" value={mobile_2} maxLength={15} inputMode="numeric" onChange={(e)=>setMobile_2(e.target.value.replace(/\D/g,""))} />
                          </div>
                        </div>
                      </div>
