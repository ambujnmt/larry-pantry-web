...
// NOTE (client requirement): This auto-generated invoice is HIDDEN from the UI.
// Client now uploads their own QuickBooks invoice per-order instead
// (see InvoiceUploadButton.jsx + adminApi.uploadOrderInvoice).
// Keeping this function here, unused, in case it's needed again later.
export default function generateInvoicePdf(order) {
