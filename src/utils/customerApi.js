...
export const customerVerifyOtp = ({ email, otp }) =>
  client("/verify-otp", { method: "POST", body: { email, otp } })

export const customerResendOtp = ({ email }) =>
  client("/send-otp", { method: "POST", body: { email } })
...
export const changeCustomerPassword = (old_password, new_password) =>
